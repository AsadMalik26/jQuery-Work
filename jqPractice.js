...
function handleBtnClick() {
    ...
    console.log(document.getElementById("newTodo").innerHTML = "Abcdefghijklmnopqrstuvwxyz");
    console.log(typeof(document.getElementById("newTodo").innerHTML));
...
function edit() {
    ...
    document.getElementById("editMe").innerHTML = "Trying to change inner HTML? Lets see it effect the nested elements too or not <button>Yes! Button also effected</button>";
    console.log(document.getElementById("editMe").innerHTML);
}